...
SERVER*CORS*ORIGINS=http://localhost:3000,http://localhost:3001
SERVER*LOGGING*REQUESTS=true
...
SERVER*HTTPS*REDIRECTHTTP=true
SERVER*CORS*ENABLED=true
SERVER*CORS*ORIGINS=https://myapp.com,https://www.myapp.com
SERVER*RATELIMIT*ENABLED=true
SERVER*RATELIMIT*MAXREQUESTS=1000
SERVER*SECURITY*HELMET*ENABLED=true
SERVER*SECURITY*HELMET*HSTS=true
